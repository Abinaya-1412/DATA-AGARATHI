...
@Component({
  selector: 'app-data-profile-datatype',
  templateUrl: './data-profile-datatype.component.html',
  styleUrls: ['./data-profile-datatype.component.scss']
})
export class DataProfileDatatypeComponent {
  constructor(
  ...
  getTableData() {
    this.services.getdata_profile_datatype().subscribe({
      next: res => {
