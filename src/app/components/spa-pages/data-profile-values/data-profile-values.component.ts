...
@Component({
  selector: 'app-data-profile-values',
  templateUrl: './data-profile-values.component.html',
  styleUrls: ['./data-profile-values.component.scss']
})
export class DataProfileValuesComponent {
  constructor(
  ...
  getTableData() {
    this.services.getdata_profile_values().subscribe({
      next: res => {
