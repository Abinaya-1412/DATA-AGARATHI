...
@Component({
  selector: 'app-factsheet-master',
  templateUrl: './factsheet-master.component.html',
  styleUrls: ['./factsheet-master.component.scss']
})
export class FactsheetMasterComponent {
  constructor(
  ...
  getTableData() {
    this.services.getfactsheet_master().subscribe({
      next: res => {
