...
@Component({
  selector: 'app-service-level-badge',
  templateUrl: './service-level-badge.component.html',
  styleUrls: ['./service-level-badge.component.scss']
})
export class ServiceLevelBadgeComponent {
  constructor(
  ...
  getTableData() {
    this.services.getservice_level_badge().subscribe({
      next: res => {
