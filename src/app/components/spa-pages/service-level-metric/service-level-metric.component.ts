...
@Component({
  selector: 'app-service-level-metric',
  templateUrl: './service-level-metric.component.html',
  styleUrls: ['./service-level-metric.component.scss']
})
export class ServiceLevelMetricComponent {
  constructor(
  ...
  getTableData() {
    this.services.getservice_level_metric().subscribe({
      next: res => {
