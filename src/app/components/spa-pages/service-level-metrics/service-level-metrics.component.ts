...
@Component({
  selector: 'app-service-level-metrics',
  templateUrl: './service-level-metrics.component.html',
  styleUrls: ['./service-level-metrics.component.scss']
})
export class ServiceLevelMetricsComponent {
  constructor(
  ...
  getTableData() {
    this.services.getservice_level_metrics().subscribe({
      next: res => {
